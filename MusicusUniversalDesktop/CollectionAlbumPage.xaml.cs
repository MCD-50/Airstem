...
{ 
    public sealed partial class CollectionAlbumPage
    {
        ...
        {
            App.Locator.CollectionAlbum.SetAlbum((int)id);
        ...
        {
            var queueSongs = App.Locator.CollectionAlbum.Album.Songs.ToList();
        ...
        private async void AddAll(object sender, RoutedEventArgs e)
        {
            ...
            {
                var tracks = App.Locator.CollectionAlbum.Album.Songs.ToList();

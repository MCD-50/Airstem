...
namespace Musicus.Data.Extensions
{
    public static class RestRequestExtensions
    {
        ...
        /// </returns>
        public static async Task<RestResponse<Model.WebData.Void>> GetRestResponseAsync<T>(
            this T request,
            Action<RestResponse<Model.WebData.Void>> successAction = null,
            Action<RestResponse<Model.WebData.Void>> errorAction = null)
            where T : RestRequest
        {
            if (request.Request.Method.Method != "GET" && request.Request.Content == null && request.Param.Count > 0)
                request.AddFormUrl(); // Add form url encoded parameter to request if needed
        ...
        ///     A taks containing the RestResponse with the deserialized data if T is not IVoid and no error occured.
        /// </returns>
        public static async Task<RestResponse<Model.WebData.Void>> Fetch(
            this RestRequest request,
            Action<RestResponse<Model.WebData.Void>> successAction = null,
            Action<RestResponse<Model.WebData.Void>> errorAction = null)
        {
        ...
        public static async Task<RestResponse<Model.WebData.Void>> UploadFileBinary(
            this RestRequest request,
            Stream streamContent,
            string contentType,
            Action<RestResponse<Model.WebData.Void>> successAction = null,
            Action<RestResponse<Model.WebData.Void>> errorAction = null)
        {
            return await request.UploadFileBinary<Model.WebData.Void>(streamContent, contentType, successAction, errorAction);
        }
